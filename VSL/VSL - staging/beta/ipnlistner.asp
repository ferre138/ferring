...
'assign posted variables to local variables
 ...
 custom           = Decode(Request.Form("custom"))
...
function getEmailText(InvId,conn)
	...
	sBody  =sBody & "<br /><div style='font-family: Verdana;font-size: 14px; padding-top:10px;' ><a href='http://www.vsl3.ca/admin/'><i>Please login to see the payment.</i></a></div>"
