...
<table  width="820" border="0" cellpadding="0" cellspacing="0" id="Table_01">
            <tr>
            <td width="301" rowspan="2"><img src="images/title_order.png" ></td>
              <td width="379" rowspan="2"><div align="center"></div></td>
...
<div class="t"  align="center">
  <div align="right" class="vslcss"><a href="vslCart.asp">View Cart</a> :
		    <%
	Dim Security
...
%>
					<%if((Month(now()) & year(now())="102012") or ((Month(now()) & year(now())="92012"))) then %>
						<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >5th Anniversary Sale </font></p>
						<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >From October 1st to October 31st, 2012 </font></p>
						...
						<p style="background-color: #FFFFCC;"><font color="#FF0000"  >To take advantage of this <b>Sale</b>,  existing customers please use the coupon code which you will receive shortly in the mail.<br/> For new customers please call the order desk to get your coupon code and place your order.</font></p>
...
<% End If %>
<% End If %></td>
	  <td width="288"><p class="bodybold"><%= Products.Description.ViewValue %></p>
	    <p class="vslcss"><em>UPC: <%= Products.UPC.ViewValue %><br>
	      Item #: <%= Products.ItemNo.ViewValue %></em> </p></td>
	  <td<%= Products.Active.CellAttributes %>><p align="right" class="vslcss"><strong>Price:</strong> $<%= Products.Price.ViewValue %> /pack<br> 
	    <br>
	      <span class="ewSearchOpr">Order 5 or more &amp;</span> <strong class="ewHighlightSearch"><em>save $5</em></strong><span class="ewSearchOpr"> per pack
          </span> <br>
          <span class="ewSearchOpr">Order 20 or more &amp; get </span><strong class="ewHighlightSearch"><em>2 more free!</em></strong> </p>
	    <p align="right" class="vslcss"><br>
            <strong>Qty :</strong>
            <input name="<%=right("000" & RowCnt,3)%>_Qty" type="text" value="0" size="5">
            <br>
            <span class="footer">Minimun Qty:2</span>  
  ...
  <br>
  <input name="Add to cart22" type="image" class="InputNoBorder" value="Add to cart" src="images/addtocart.gif" align="right">
	      </p></td>
	</tr>
	<tr>
...
<tr>
  ...
  <div >
    ...
    <p align="left" class="vslcss">Single or multiple boxes of VSL #3 can also be ordered from your local pharmacy. <br>
        <br>
        If you have questions on how to order via the website or about VSL#3, please call Ferring Pharmaceuticals at 1-416-642-0075 or toll free at 1-877-681-7464 during business hours  (Mon - Fri 8:00 am to 4:00 pm EST) or send us an email at VSL3@ferring.com. </p>
    ...
    <p align="left" class="vslcss">&nbsp;</p>
    <p align="left" class="vslcss">If you are paying using cash please phone Ferring Pharmaceuticals at 1-416-642-0075 or toll free at 1-877-681-7464 to place your order. </p>
    <p align="left" class="vslcss">&nbsp;</p>
