...
%>
					<%if((Month(now())<=12)  and (year(now())=2017)) then
                      if( (day(now())<=15)) then %>
						...
						<p style="background-color: #FFFFCC;"><font color="#FF0000"  >Until December 18th, 2017, with every 3 cartons of VSL#3  you purchase, you will receive a 4th carton at no charge.  Free goods will be calculated at time of shipment
