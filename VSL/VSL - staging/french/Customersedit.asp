...
//-->
            ...
            <tr>
            <td rowspan="2"><img src="images/title_account_fr.png" width="410" height="75"></td>
            
            </tr>
            <tr>
              <td colspan="4" align="right" valign="top"><div align="right">
                <p class="bodycopy_small" style="color: #1070A3"><a href="../Customersedit.asp" class="bodycopy_small">english  &gt;</a></p>
              </div></td>
              </tr>
        </table>
<%
...
<div class="t">
  <div align="right" class="vslcss"><a href="VSLOrderForm.asp">Retour aux produits </a> : <a href="vslCart.asp">Visualiser le panier </a> :
		    <%
  ...
  <table width="800" border="0" cellspacing="0" cellpadding="0">
	...
	<tr class="ewTableAltRow">
	  <td colspan="2" class="ewTableHeader">Adresse</td>
	  </tr>
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Prénom<span class='ewmsg'>&nbsp;*<span id="cb_x_CustomerID">
...
<input type="text" name="x_Inv_FirstName" id="x_Inv_FirstName" title="" size="30" maxlength="30" value="<%= Customers.Inv_FirstName.EditValue %>"<%= Customers.Inv_FirstName.EditAttributes %>>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">Nom<span class='ewmsg'>&nbsp;*</span></td>
...
<input type="text" name="x_Inv_LastName" id="x_Inv_LastName" title="" size="30" maxlength="50" value="<%= Customers.Inv_LastName.EditValue %>"<%= Customers.Inv_LastName.EditAttributes %>>
	...
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Adresse<span class='ewmsg'>&nbsp;*</span></td>
...
<input type="text" name="x_Inv_Address2" id="x_Inv_Address2" title="" size="30" maxlength="255" value="<%= Customers.Inv_Address2.EditValue %>"<%= Customers.Inv_Address2.EditAttributes %>>
	...
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Ville<span class='ewmsg'>&nbsp;*</span></td>
...
%>
	...
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Code postal<span class='ewmsg'>&nbsp;*</span></td>
...
<input type="text" disabled name="x_inv_Country" id="x_inv_Country" title="" size="30" maxlength="50" value="Canada"<%= Customers.inv_Country.EditAttributes %>>
</span></td>
	</tr></table></td>
      <td align="center" valign="top"><table width="400" class="ewTable">
	<tr class="ewTableAltRow">
	  <td colspan="2" class="ewTableHeader">vos coordonnées </td>
	  </tr>
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Numéro de téléphone</td>
...
<input type="text" name="x_inv_PhoneNumber" id="x_inv_PhoneNumber" title="" size="30" maxlength="30" value="<%= Customers.inv_PhoneNumber.EditValue %>"<%= Customers.inv_PhoneNumber.EditAttributes %>>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">Adresse courriel<span class='ewmsg'>&nbsp;*</span></td>
...
<input type="text" name="x_inv_Fax" id="x_inv_Fax" title="" size="30" maxlength="30" value="<%= Customers.inv_Fax.EditValue %>"<%= Customers.inv_Fax.EditAttributes %>>
        ...
        <p>&nbsp;          </p>
        <p>
          <input type="submit" name="btnAction" id="btnAction" value="   vegarder les changements   ">
        </p></td>
    </tr>
  </table>
</div>
...
Sub RenderRow()
	...
	ElseIf Customers.RowType = EW_ROWTYPE_EDIT Then ' Edit row
		...
		sSqlWrk = "SELECT [Prov], [fProvince] FROM [Province]"
