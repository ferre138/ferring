...
<table  border="0" cellpadding="0" cellspacing="0" id="Table_01">
            <tr>
            <td width="699" height="75" rowspan="2"><span class="vslcss" ><span class="Header">Droits d'auteur</span> </span></td>
...
return false;"><img name="login_15" src="images/font3.png" width="24" height="27" border="0" alt=""></a></td>
            ...
            <tr>
              <td colspan="4" valign="top"><div align="right">
                <p><a href="../copyright.asp" class="bodycopy_small">english  &gt;</a></p>
              </div></td>
              </tr>
        </table>
<p align="justify" class="vslcss"><span class="subheading">Droits d'auteur et restriction sur l'utilisation du matériel (usage non commercial) </span><br>
  Ce site web est prot&eacute;g&eacute; par des droits d'auteur. Tout mat&eacute;riel textuel ou   graphique que vous copiez, imprimez ou dont vous effectuez le t&eacute;l&eacute;chargement   vous est autoris&eacute; par Ferring et/ou ses filiales pour votre usage personnel et   r&eacute;sidentiel non commercial seulement et en autant que vous ne changiez ni ne   supprimiez aucun droit d'auteur, marque de commerce ou autre avis d'exclusivit&eacute;.<br>
  <br>
  <span class="subheading">Limitation de responsabilité </span><br>
  Ferring fera des efforts raisonnables pour donner des renseignements exacts,   complets et &agrave; jour sur ce site web mais Ferring ne donne aucune garantie ni ne   fait aucune repr&eacute;sentation quant &agrave; leur exactitude, suffisance ou la fr&eacute;quence   de leurs mises &agrave; jour. Tous les usagers conviennent que l'acc&egrave;s &agrave; ce site web   est &agrave; leur seul risque et que ni Ferring ni aucun tiers impliqu&eacute; dans la   cr&eacute;ation ou l'&eacute;laboration de ce site web ne sera tenu responsable pour des   dommages de toutes sortes, comprenant sans limitation, tous dommages sp&eacute;ciaux,   directs ou indirects, incidents ou cons&eacute;quents ou punitifs (m&ecirc;me si Ferring a   &eacute;t&eacute; avis&eacute; de la possibilit&eacute; de tels dommages) d&eacute;coulant de l'acc&egrave;s &agrave; / ou de   l'utilisation des renseignements contenus sur ce site web ainsi que de toutes   erreurs ou omissions, mauvaises impressions, renseignements d&eacute;suets,   inexactitudes techniques ou sur les prix, erreurs typographiques ou autres   apparaissant sur ce site web. Cette limitation comprend les dommages &agrave; / ou pour   tous virus pouvant contaminer votre &eacute;quipement informatique. </p>
