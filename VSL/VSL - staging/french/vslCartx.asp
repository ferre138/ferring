...
dim strItemId,strUnit_Qty,strDESCRIPTION,strPrice
	...
	Next
	call CheckQty(tqty,"VSLOrderFormx.asp")
	...
	For Each fldName in Request.Form
		if(left(fldName,6)="ItemId") then 
			...
			'else
			''	call CheckQty(strUnit_Qty,"VSLOrderFormx.asp")
			'end if
		End if
...
<table width="775"  border="0" cellpadding="0" cellspacing="0" id="Table_01">
  ...
  <tr>
    <td colspan="4" valign="top"><div align="right">
      <p class="bodycopy_small" style="color: #1070A3"><a href="../vslCartx.asp" class="bodycopy_small">english  &gt;</a></p>
    </div></td>
    </tr>
</table>

<form method="post" action="vslCartx.asp"> 
<div class="t">
  <div align="right"><span class="vslcss"><a href="vslorderformx.asp">Retour aux produits</a> :
          <%
	Dim Security
...
<table width="775"  class="ewTablecart" cellpadding="5" cellspacing="5" border="1">
  ...
  <tr >
    ...
    <td width="10%">
      <div align="center"><b><a href='vslCartx.asp?ItemId=<%=arr(i,0)%>&link=del' onClick="return confirm('Supprimer l\'article <%=arr(i,0)%> du panier d\'achat?')"><b>Enlevez</b></a>
  ...
  <tr bordercolor="#FFCC66">
    ...
    <td colspan="4" nowrap><a href="vslCartx.asp?link=checkout"><img src="images/checkout_fr.gif" width="76" height="32" border="0"></a> <a href="vslCartx.asp?link=clear" onClick="return confirm(' Retirer tous les articles du panier d\'achat?');"><img src="images/cancelorder_fr.gif" width="200" height="32" border="0"></a></td>
    </tr>
</table>
</div>
</form> 
...
Sub VerifyCart()
	...
	'MinQtyCheck()
	if(QtyCheck) then 
		response.redirect ("vslCartx.asp?link=finalize")
	else
		EmptyCart()
		response.redirect ("vslorderformx.asp")
	end if
End Sub
...
Sub Message(t)
	...
	'Response.Write("                <tr>" & vbcrlf) 
	'Response.Write("                  <td align='right'><a href=""french/vslCartx.asp"" class=""bodycopy_small"">en fran&ccedil;ais &gt;</a></td>" & vbcrlf) 
	'Response.Write("                </tr>" & vbcrlf) 
	'Response.Write("                <tr>" & vbcrlf) 
	...
	case "emptycart"
		...
		Response.Write("            <a href='vslorderformx.asp?cmd=resetall'><img src=""images/clicktoreturn.gif""  border=0></a><br> " & vbcrlf) 
	...
	case "saveheld"
		...
		Response.Write("            <a href='vslCartx.asp?link=getHeldOrders'><img src=""images/clicktoreturn.gif"" width=""181"" height=""23"" border=0></a><br> " & vbcrlf) 
		Response.Write("            </p> </td> " & vbcrlf) 
		Response.Write("        </tr> " & vbcrlf) 
		Response.Write("      </table>") 
	end select
