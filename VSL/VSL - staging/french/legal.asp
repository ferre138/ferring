...
<table  border="0" cellpadding="0" cellspacing="0" id="Table_01">
            <tr>
            <td  width="699" height="75" rowspan="2"><span class="vslcss"><span class="Header">Avis juridique
</span></span></td>
...
return false;"><img name="login_15" src="images/font3.png" width="24" height="27" border="0" alt=""></a></td>
            ...
            <tr>
              <td colspan="4" valign="top"><div align="right">
                <p><a href="../legal.asp" class="bodycopy_small">english  &gt;</a></p>
              </div></td>
              </tr>
        </table>
<p align="justify" class="vslcss"> <span class="subheading">Ferring Inc. (Canada) Conditions de l'utilisation du site web </span><br>
  VEUILLEZ LIRE ET R&Eacute;VISER ATTENTIVEMENT LES TERMES ET CONDITIONS QUI  SUIVENT AVANT D'UTILISER CE SITE WEB. En utilisant ce site web, vous  convenez &agrave; ces termes et conditions. Si vous n'en convenez pas,  veuillez quitter et ne pas tenir compte des renseignements contenus aux  pr&eacute;sentes.<br>
<br>
<span class="subheading">Renseignements généraux </span><br></p>
<p>N'h&eacute;sitez pas &agrave; explorer ce site web. Votre acc&egrave;s et utilisation des   renseignements contenus aux pr&eacute;sentes sont sujets aux termes et conditions ainsi   qu'&agrave; toutes les lois applicables. En acc&eacute;dant et explorant ce site web, vous   acceptez, sans limitation ou qualification, ces termes et conditions et   reconnaissez qu'ils ont pr&eacute;s&eacute;ance sur toute autre entente entre vous et   Ferring.</p>
<p>&nbsp;</p>
<p>Ferring maintient ce site web pour votre utilisation   personnelle. Ce site web et son contenu sont conformes avec les lois et   r&egrave;glements du Canada. Bien que vous puissiez acc&eacute;der &agrave; ce site web &agrave; l'ext&eacute;rieur   du Canada, notre serveur est situ&eacute; au Canada et le site web est con&ccedil;u pour &ecirc;tre   utilis&eacute; par les r&eacute;sidents du Canada. </p>
<p align="justify" class="vslcss"><br>
    <br>
    <span class="subheading">Renseignements médicaux/Conditions      </span> <br>
</p>
<p>Veuillez prendre note que les renseignements sur les produits pr&eacute;sent&eacute;s sur ce   site web ne sont qu'un bref r&eacute;sum&eacute; con&ccedil;u pour la commodit&eacute; du visiteur   relativement aux activit&eacute;s du groupe Ferring. Les produits ou indications ne   sont pas tous autoris&eacute;s dans chaque pays et peuvent &ecirc;tre sujets &agrave; des variations   locales. Pour des renseignements particuliers sur les produits, veuillez   consulter les r&eacute;sum&eacute;s locaux sur les caract&eacute;ristiques des produits. Veuillez   consulter votre m&eacute;decin local pour un avis sur les enjeux m&eacute;dicaux.</p>
<p>&nbsp;</p>
<p>Bien qu'il puisse y avoir des renseignements sur ce site web   reli&eacute;s &agrave; certains &eacute;tats pathologiques et leur traitement, si un &eacute;tat   pathologique existe, voyez promptement votre propre m&eacute;decin ou fournisseur de   soins de sant&eacute;. Ferring n'offre pas de diagnostiques m&eacute;dicaux personnalis&eacute;s ou   d'avis de traitement particulier au patient. En r&eacute;alit&eacute;, seul votre m&eacute;decin ou   autre professionnel de soins de sant&eacute; en tant qu'interm&eacute;diaire savant peut   d&eacute;terminer si un produit d&eacute;crit sur ce site web vous est convenable.</p>
<p>&nbsp;</p>
<p>VEUILLEZ CONSULTER VOTRE M&Eacute;DECIN OU AUTRE PROFESSIONNEL   QUALIFI&Eacute; DES SOINS DE SANT&Eacute; AVANT D'UTILISER TOUT PRODUIT DISCUT&Eacute; SUR CE SITE   WEB.
</p>
