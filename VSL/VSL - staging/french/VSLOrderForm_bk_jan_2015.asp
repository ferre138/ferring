...
<table  border="1" cellpadding="0" cellspacing="0" id="Table_01">
            <tr>
            <td width="340" rowspan="2"><img src="images/title_order_fr.png" width="364" height="75"></td>
              <td width="340" rowspan="2"><div align="right"></div></td>

             
            </tr>
            <tr>
              <td colspan="4" valign="top"><div align="right">
                <p class="bodycopy_small" style="color: #1070A3"><a href="../VSLOrderForm.asp" class="bodycopy_small">english  &gt;</a></p>
              </div></td>
              </tr>
        </table>
...
%>
			<%if((Month(now()) & year(now())="102013") or ((Month(now()) & year(now())="92013"))) then %>
				<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >Vente anniversaire finale</font></p>
				<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >du 1er au 31 octobre 2013</font></p>
				<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >&Agrave;&nbsp;tous nos chers clients, Ferring Produits Pharmaceutiques &agrave; le plaisir de vous  annoncer &nbsp;une <em>vente anniversaire finale pour le VSL#3.</em></font></p>
				<p style="background-color: #FFFFCC;"><font color="#FF0000"  >&Agrave;&nbsp;partir du 1er  octobre jusqu'au 31 octobre inclusivement, avec l'achat de 3 bo&icirc;tes de VSL#3  vous recevrez la 4i&egrave;me bo&icirc;te sans frais. <br />
  Ceci est votre  derni&egrave;re chance de prendre avantage de cette offre.&nbsp; La date d&rsquo;expiration  du produit envoy&eacute; est jusqu&rsquo;au 30 avril 2015. </font></p>
			<%end if %>
             <%if((Month(now()) & year(now())="122013") ) then %>
				 <span class="bodycopy_alert"> ATTENTION! <br>
La dernière journée pour placer votre commande de VSL#3 pour une livraison le lendemain sera  jeudi le 19 décembre 2013.  Nous recommencerons le 6 janvier 2014 pour un service de livraison pour le lendemain 
</span><br>
				  <%end if%>
	</td></tr>
<%
...
%></td>
	  <td width="288"><p class="bodybold"><%= Products.fDescription.ViewValue %></p>
	  ...
	  <td align="right"<%= Products.Active.CellAttributes %>><p align="right" class="vslcss"><strong>Prix unitaire:</strong><%= Products.Price.ViewValue %> $ boite<br> 
	    <br>
	      <span class="ewSearchOpr">Commandez 5 ou plus et</span> <strong class="ewHighlightSearch"><em>épargnez 5,00 $ </em></strong><span class="ewSearchOpr"> par boîte
          </span> <br>
          <span class="ewSearchOpr">Commandez 20 boîtes ou plus et obtenez </span><strong class="ewHighlightSearch"><em> 2 boîtes suppémentaires gratuitement </em></strong> </p>
	    <p align="right" class="vslcss"><br>
            ...
            <br>
            <span class="footer">Qté minimale:2</span>  
...
<tr>
  ...
  <div >
    <p align="left" class="vslcss" >&nbsp;</p>
	 <p align="left" class="vslcss"><strong>La dernière journée pour placer un commande sera minuit, le 17 décembre pour une livraison par le 19 décembre.  Les livraisons reprennent le 5 janvier, 2015.</strong></p>
