...
function ew_ValidateForm(fobj) {
	...
	for (i=0; i<rowcnt; i++) {
		...
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- Prénom"))
				return false;
		}
		elm = fobj.elements["x" + infix + "_Inv_LastName"];
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- Nom"))
				return false;
		}
		elm = fobj.elements["x" + infix + "_Inv_Address"];
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- Billing Address"))
				return false;
		}
		elm = fobj.elements["x" + infix + "_inv_City"];
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- City"))
				return false;
		}
		elm = fobj.elements["x" + infix + "_inv_Province"];
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- Province"))
				return false;
		}
		elm = fobj.elements["x" + infix + "_inv_PostalCode"];
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- Postal Code"))
				return false;
		}
		elm = fobj.elements["x" + infix + "_inv_PostalCode"];
		if (elm && !isValidPostal(elm.value)) {
			if (!ew_OnError(elm, "S'il vous plaît entrez à un Code Postal valide "))
				return false;
		}
		elm = fobj.elements["x" + infix + "_inv_PhoneNumber"];
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- Numéro de téléphone"))
				return false;
		}
		elm = fobj.elements["x" + infix + "_inv_PhoneNumber"];
		if (elm && !checkInternationalPhone(elm.value)) {
			if (!ew_OnError(elm, "Mauvais  numéro de téléphone "))
				return false;
		}
		elm = fobj.elements["x" + infix + "_inv_EmailAddress"];
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- Adresse courriel "))
				return false;
		}
		elm = fobj.elements["x" + infix + "_inv_EmailAddress"];
		if (elm && !ew_CheckEmail(elm.value)) {
			if (!ew_OnError(elm, "S'il vous plaît entrez un adresse de courriel valide"))
				return false;
		}

		elm = fobj.elements["x" + infix + "_UserName"];
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- User Name"))
				return false;
		}
    ...
    if ( /[^A-Za-z\d]/.test(elm.value)) {
		...
		if (elm && !ew_HasValue(elm)) {
			if (!ew_OnError(elm, "S’il vous plait entrez les cases exigées- passwrd"))
				return false;
		}
...
<table  border="0" cellpadding="0" cellspacing="0" id="Table_01">
            <tr>
            <td width="680" rowspan="2"><img src="images/title_newaccount_fr.png" width="410" height="75"></td>
             
            </tr>
            <tr>
              <td colspan="4" valign="top"><div align="right">
                <p class="bodycopy_small" style="color: #1070A3"><a href="../register.asp" class="bodycopy_small">english  &gt;</a></p>
              </div></td>
              </tr>
        </table>
...
<p> Veuillez prendre quelques instants pour inscrire votre nouveau compte.<br>
  <span class="vslcss">Vous avez déjà un  <a href="login.asp">compte</a> chez nous ? ou vous avez oublié votre mot de </span><span class="vslcss"><a href="forgetpwd.asp">passe</a> ?</span></p>
<p><span class="vslcss"> </span></p>
<div class="t"><div align="right" class="vslcss"><a href="VSLOrderForm.asp">Retour aux produits </a> :  <a href="vslCart.asp">Visualiser le panier </a> :<a href="login.asp">inscription<br>
          </a>
            </div>
<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span> <span class="vslcss">Les champs ombrés sont obligatoires</span>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="ewTable">
 <tr class="ewTableAltRow">
		<td class="ewTableHeader">Nom d’utilisateur<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
...
<input type="text" name="x_UserName" id="x_UserName" title="" size="30" maxlength="15" value="<%= Customers.UserName.EditValue %>"<%= Customers.UserName.EditAttributes %>>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">Mot de passe<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
...
<input type="password" name="x_passwrd" id="x_passwrd" title=""  value="<%= Customers.passwrd.EditValue %>" size="30" maxlength="15"<%= Customers.passwrd.EditAttributes %>>
	...
	<!--tr id=""-->
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Confirmation du mot de passe<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
		<td<%= Customers.passwrd.CellAttributes %>>
<input type="password" name="c_passwrd" id="c_passwrd" title=""  value="<%= Customers.passwrd.EditValue %>" size="30" maxlength="15"<%= Customers.passwrd.EditAttributes %>>
	...
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Adresse courriel<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
...
<table width="100%" class="ewTable">
	<tr class="ewTableRow">
		<td class="ewTableHeader">Prénom<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
...
<input type="text" name="x_Inv_FirstName" id="x_Inv_FirstName" title="" size="30" maxlength="30" value="<%= Customers.Inv_FirstName.EditValue %>"<%= Customers.Inv_FirstName.EditAttributes %>>
	...
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Nom<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
...
<input type="text" name="x_Inv_LastName" id="x_Inv_LastName" title="" size="30" maxlength="50" value="<%= Customers.Inv_LastName.EditValue %>"<%= Customers.Inv_LastName.EditAttributes %>>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">Adresse<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
...
<input type="text" name="x_Inv_Address" id="x_Inv_Address" title="" size="30" maxlength="255" value="<%= Customers.Inv_Address.EditValue %>"<%= Customers.Inv_Address.EditAttributes %>>
	...
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Adresse 2</td>
...
<input type="text" name="x_Inv_Address2" id="x_Inv_Address2" title="" size="30" maxlength="255" value="<%= Customers.Inv_Address2.EditValue %>"<%= Customers.Inv_Address2.EditAttributes %>>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">Ville<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
...
%>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">Code postal<span class="vslcss"><span class='ewmsg'>&nbsp;*</span></span></td>
...
<input type="text" name="x_inv_PostalCode" id="x_inv_PostalCode" title="" size="30" maxlength="20" value="<%= Customers.inv_PostalCode.EditValue %>"<%= Customers.inv_PostalCode.EditAttributes %>>
	...
	<tr class="ewTableAltRow">
		<td class="ewTableHeader">Pays</td>
...
<input type="text" name="x_inv_Country" id="x_inv_Country" title="" size="30" maxlength="50" value="Canada"<%= Customers.inv_Country.EditAttributes %> disabled>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">Numéro de téléphone, le jour <span class="vslcss"><span class='ewmsg'>*</span></span><br>
		  (xxx) xxx-xxxx</td>
...
<input type="text" name="x_inv_PhoneNumber" id="x_inv_PhoneNumber" title="" size="30" maxlength="30" value="<%= Customers.inv_PhoneNumber.EditValue %>"<%= Customers.inv_PhoneNumber.EditAttributes %>>
	...
	<tr class="ewTableRow">
		<td class="ewTableHeader">Numéro de télécopieur</td>
...
<table>
	<tr>
	    ...
	    <td><span class="vslcss">Veuillez entrer le numéro de validation inscrit à gauche<span class='ewmsg'>&nbsp;*</span></span><br>
...
<br>
<!-- captcha html (end) -->
<input type="submit" name="btnAction" id="btnAction" value=" Inscription ">
<br>
</div>
</form>
...
Sub RenderRow()
	...
	ElseIf Customers.RowType = EW_ROWTYPE_ADD Then ' Add row
		...
		rswrk.Close
		Set rswrk = Nothing
		arwrk = ew_AddItemToArray(arwrk, 0, Array("", "Choisissez"))
