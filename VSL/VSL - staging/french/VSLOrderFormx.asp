...
<table  border="0" cellpadding="0" cellspacing="0" id="Table_01">
            ...
            <tr>
              <td colspan="4" valign="top"><div align="right">
                <p class="bodycopy_small" style="color: #1070A3"><a href="../vslorderformx.asp" class="bodycopy_small">english  &gt;</a></p>
              </div></td>
              </tr>
        </table>
...
<form action="vslCartx.asp" method="post" name="fQProductslist" id="fQProductslist" >
    <% if (not isNewCustomer()) then %>
            <strong class="ewHighlightSearch"><em>Qté minimale:2</em></strong>
    <%end if%> 
<div class="t"  align="center">
  <div align="right" class="vslcss"><a href="vslCartx.asp">Visualiser le panier </a> :
		    <%
	Dim Security
