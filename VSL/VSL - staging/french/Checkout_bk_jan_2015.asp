...
function getAddress(c)
	...
	if(not rs.eof) then 
	'response.write rs("inv_Country") & "xx"
	%> 
                </span> </div> 
	...
	<tr align="left" valign="top">
		...
		<td width="50%"><!-- <input type="checkbox" name="CheckLocalPickup" id="CheckLocalPickup" onClick="javascript:localAddress();"><span class="aspmaker">Recueil local à Toronto seulement</span>--></td>
                  ...
                  </tr>  </table></form><form method="post" id="promoform" onSubmit="javascript:fillship();"><input type="hidden" name="shipvalues" id="shipvalues" value="" /><table>
                  <tr> 
  ...
  Ceci est votre  derni&egrave;re chance de prendre avantage de cette offre.&nbsp; La date d&rsquo;expiration  du produit envoy&eacute; est jusqu&rsquo;au 30 avril 2015. </font></p>
			<%end if %>
			<p align="left"><font size="2"><strong>La dernière journée pour placer un commande sera minuit, le 17 décembre pour une livraison par le 19 décembre.  Les livraisons reprennent le 5 janvier, 2015.</strong></font></p>
					<br>
					<p><font size="2">
					  Vous recevrez une confirmation et vous serez avisé de la date de livraison de votre commande par courriel ou par téléphone.</font></p>
                      <p><font size="2"><strong>Veuillez prendre note qu’une personne devra se trouver à votre adresse le jour de la livraison pour recevoir le paquet et s’assurer qu’il reste réfrigéré.  </strong></font></p>
                      <p><font size="2">La commande sera expédiée dans un emballage isolé contenant des blocs réfrigérants pour maintenir la température d’entreposage au niveau exigé et elle sera livrée par un service de messagerie.
