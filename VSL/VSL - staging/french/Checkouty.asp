...
function getAddress(c)
	...
	<tr align="left" valign="top">
		...
		<td width="50%"><!-- <input type="checkbox" name="CheckLocalPickup" id="CheckLocalPickup" onClick="javascript:localAddress();"><span class="aspmaker">Recueil local à Toronto seulement</span>--></td>
				...
				<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >Jusqu’au 18 décembre ou jusqu’à l’épuissement des stocks</font></p>
    ...
    <p style="background-color: #FFFFCC;"><font color="#FF0000"  >Jusq&ugrave;au 18 décembre, 2017,  avec chaque achat de 3  bo&icirc;tes de VSL#3, vous recevrez une 4i&egrave;me bo&icirc;te sans frais, jusq&ugrave;&agrave; l’&egrave;puissement des stocks <br />
  </font></p>
					<%end if
                    end if
                    %>
 <span class="ewmsg"> C’est la dernière semaine à commander pour 2017. <br>
Nous sommes fermés pour les fêtes du 18 décembre au 2 janvier, 2018.
</span><br>
					<p><font size="2">
