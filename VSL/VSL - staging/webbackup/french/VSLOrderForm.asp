...
%>
<p align="center"><span class="ewmsg"><%= Session(EW_SESSION_MESSAGE) %></span></p>
<%
	Session(EW_SESSION_MESSAGE) = "" ' Clear message
End If
%>
<%if(Month(now()) & year(now())="102009") then %>
<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+0" >Pour chaque 3 boîtes que vous achetez, une boîte gratuite sera ajoutée à votre commande.  Veuillez commander le nombre de boîtes pour lesquelles vous voulez être facturés, et vous recevrez votre confirmation par courriel qui vous donnera le nombre de boîtes gratuites qui seront expédiées avec votre commande.</font></p>
	<%end if %></td></tr>
<%
...
%></td>
	  ...
	  <td<%= Products.Active.CellAttributes %>><p align="right" class="vslcss"><strong>Prix unitaire:</strong> $<%= Products.Price.ViewValue %> /pack<br> 
	    <br>
  ...
  <br>
  <input name="Add to cart22" type="image" class="InputNoBorder" value="Add to cart" src="images/addtocart_fr.gif" align="right">
	      </p></td>
	</tr>
	<tr>
...
<tr>
  ...
  <div >
    ...
    <p align="left" class="vslcss" >&nbsp;</p>
    <p align="left" class="vslcss">Si vous payez par ch&egrave;que, veuillez appeler Ferring Produits Pharmaceutiques au 1-416-642-0075 ou   sans frais 1-877-681-7464 pour passer votre commande. </p>
    <p align="left" class="vslcss">&nbsp;</p>
    <p align="left" class="vslcss">Si vous avez des questions sur la fa&ccedil;on de commander par l'interm&eacute;diaire du site Web ou au sujet du VSL#3, veuillez appeler Ferring Produits Pharmaceutiques au 1-416-642-0075 ou   sans frais 1-877-681-7464 pendant les heures normales d'ouverture (lundi au vendredi de 8 h &agrave; 17 h HNE) ou faites-nous parvenir un courriel &agrave; <a href="mailto:VSL3@ferring.com">VSL3@ferring.com</a>.</p>
    <p align="left" class="vslcss">&nbsp;</p>
    <p align="left" class="vslcss">Tous les prix sont en dollars canadiens. </p>
