...
<table width="820"  border="0" cellpadding="0" cellspacing="0" id="Table_01">
            <tr>
            <td width="680" rowspan="2"><img src="images/title_order.png" ></td>
...
return false;"><img name="login_15" src="images/font3.png" width="24" height="27" border="0" alt=""></a></td>
            ...
            <tr>
              <td colspan="4" valign="top"><div align="right">
                <p><a href="french/login.asp" class="bodycopy_small">en fran&ccedil;ais &gt;</a></p>
              </div></td>-->
              </tr>
        </table>
...
<div class="t">
  <p>
  <div align="right" class="vslcss"><a href="VSLOrderForm.asp">Back to Products</a> : <a href="vslCart.asp">View Cart</a> </div>
  </p>
  <table width="775" border="0" align="center" cellpadding="4" cellspacing="0" class="ewTable">
      ...
      <tr>
        <td width="50%" rowspan="3"><div align="center">Don't have a Account? <br>
  Signing up is easy. </div></td>
	    <td rowspan="3">&nbsp;</td>
	    <td height="15"><span class="vslcss">User Name</span></td>
	...
	<tr>
	  <td height="15"><span class="vslcss">Password</span></td>
		<td><span class="vslcss"><input type="password" name="password" id="password" size="20"></span></td>
	</tr>
	<tr>
	  <td height="15">&nbsp;</td>
		<td><span class="vslcss"><a href="forgetpwd.asp">Forgot your password?</a>
		</span></td>
	</tr>
	<tr>
