...
<input type="hidden" name="invoice" value="demo-<%=OrderNum%>">
<input type="hidden" name="custom" value="<%if(applyDiscount) then response.write encode(session("promocode"))%>">
<input type="hidden" name="currency_code" value="CAD">
<input type="hidden" name="return" value="http://www.vsl3.ca/Thank-you.asp?token=<%=OrderNum%>">	
<input type="hidden" name="cancel_return" value="http://www.vsl3.ca/Cancel_order.asp?token=<%=OrderNum%>&txt=<%=CustId%>">
