...
<table width="820" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><h3 class="red-box-sm white text-center">Effective June 1, 2015, the price of VSL#3 will increase to $110.00 per box. <br />
      The new price will include the shipping charge.</h3></td>
  </tr>
</table>

<table  width="820" border="0" cellpadding="0" cellspacing="0" id="Table_01">
            <tr>
            <td width="301" rowspan="2"><h1 class="h1-header" style="padding:20px 0px 20px 0px; color:#0067A7;">Order VSL#3 Here</h1></td>
