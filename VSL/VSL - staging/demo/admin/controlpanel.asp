...
<tr>
    <td colspan="3"><% Call renderChartHTML("Charts/FCF_Column3D.swf", "", strXML, "myNext", 1000, 250)%></td>
    </tr>
...
%></td>
  ...
  <tr>
	...
	strHtml=""
	sSql = "SELECT top 6 Orders.Ship_LastName & ' ' & Orders.Ship_FirstName AS fullname, Orders.Ship_City, Orders.Ship_Province, Orders.OrderId, Orders.payment_gross, Orders.payment_status,CustomerId"
	sSql=sSql & " FROM Orders WHERE (((Orders.payment_status)=""Completed"")) ORDER BY Orders.OrderId DESC;"
	rs.open sSql,conn					
		strHtml = strHtml &  "<table class='cptable'>"
		strHtml = strHtml &  "<tr class='ewTableCaption'>"
		strHtml = strHtml & "<td align='middle' valign='middle' colspan=4><h3>Recent 5 orders.. </h3></td>"
		strHtml = strHtml &  "</tr>"
		strHtml = strHtml &  "<tr class='ewTableHeader'>"
		strHtml = strHtml & "<td align='middle' valign='top'>Orders</td>"
		...
		'strHtml = strHtml & "<td align='middle' valign='top'>Province</td>"
		strHtml = strHtml & "<td align='middle' valign='top'>Order total</td>"
		strHtml = strHtml &  "</tr>"
		
	Do While not rs.EOF
		strHtml = strHtml &  "<tr>"
		strHtml = strHtml & "<td align='middle' valign='top'><a href='Orderslist.asp?t=Orders&z_CustomerId=%3D&x_CustomerId=" & rs("CustomerId") & "&z_payment_status=LIKE&x_payment_status=&z_Ordered_Date=%3D&x_Ordered_Date=&psearch=&Submit=Search+%28*%29&psearchtype='>" & rs("OrderId") & "</a></td>"
...
%></td>
	...
	strHtml=""
	sSql = "SELECT TOP 5 DiscountTypes.DiscountTitle, Count(Discountcodes.Discountid) AS CountOfDiscountid "
	sSql=sSql & " FROM Discountcodes INNER JOIN DiscountTypes ON Discountcodes.DiscountTypeId = DiscountTypes.DiscountTypeId GROUP BY DiscountTypes.DiscountTitle, Discountcodes.used HAVING (((Discountcodes.used)=False)); "
	...
	rs.open sSql,conn					
		...
		strHtml = strHtml & "<td align='middle' valign='top'>Available</td>"
	...
	Do While not rs.EOF
		...
		strHtml = strHtml & "<td align='middle' valign='top'>" & rs("DiscountTitle") & "</td>"

		
		strHtml = strHtml & "<td align='middle' valign='top'>" & rs("CountOfDiscountid") & "</td>"
		strHtml = strHtml & "<td align='middle' valign='top'>" & (1000-rs("CountOfDiscountid")) & "</td>"
		strHtml = strHtml & "<td align='middle' valign='top'>" & ((1000-rs("CountOfDiscountid"))/10)  & "%</td>"
...
<%	
	strHtml=""
	sSql = "SELECT top 5 Count(Orders.OrderId) AS CountOfOrderId, Customers.Inv_FirstName, Customers.Inv_LastName, Customers.CustomerID ,Sum(Orders.payment_gross) AS SumOfpayment_gross":
	...
	rs.open sSql,conn					
		strHtml = strHtml &  "<table class='cptable'>"
		strHtml = strHtml &  "<tr class='ewTableCaption'>"
		strHtml = strHtml & "<td align='middle' valign='middle' colspan=3><h3>Top 5 Customers.. </h3></td>"
		strHtml = strHtml &  "</tr>"
		strHtml = strHtml &  "<tr class='ewTableHeader'>"
		strHtml = strHtml & "<td align='middle' valign='top'>Customer</td>"
		strHtml = strHtml & "<td align='middle' valign='top'>Orders</td>"
		strHtml = strHtml & "<td align='middle' valign='top'>Amount</td>"
		strHtml = strHtml &  "</tr>"
		
	Do While not rs.EOF
		strHtml = strHtml &  "<tr>"
		strHtml = strHtml & "<td align='middle' valign='top'>" & rs("Inv_FirstName") & " " & rs("Inv_LastName") & "</td>"
		strHtml = strHtml & "<td align='middle' valign='top'>" & rs("CountOfOrderId") & "</td>"
		strHtml = strHtml & "<td align='middle' valign='top'>" & FormatCurrency(rs("SumOfpayment_gross")) & "</td>"
...
%></td>
	...
	Do While not rs.EOF
		...
		strHtml = strHtml & "<td align='middle' valign='top' >" & rs("inv_Province") & "</td>"
