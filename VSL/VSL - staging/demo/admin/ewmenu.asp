...
RootMenu.AddMenuItem 40, GetMenuText("40", "Control Panel"), "controlpanel.asp", -1, "", "", IsLoggedIn(), False
RootMenu.AddMenuItem 3, GetMenuText("3", "Orders"), "Orderslist.asp?cmd=resetall", -1, "", "", IsLoggedIn(), False
...
RootMenu.AddMenuItem 29, GetMenuText("29", "Discounts"), "Discountcodeslist.asp?cmd=resetall", 12, "", "", IsLoggedIn(), False
RootMenu.AddMenuItem 6, GetMenuText("6", "Province"), "Provincelist.asp", 12, "", "", IsLoggedIn(), False
RootMenu.AddMenuItem 28, GetMenuText("28", "Orders Report"), "reportDaily.asp", -1, "", "", IsLoggedIn(), False
