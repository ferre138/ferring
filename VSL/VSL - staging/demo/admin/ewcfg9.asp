...
Const EW_PROJECT_NAME = "vslpaypal" ' Project Name
...
EW_SESSION_LANGUAGE_FILE_CACHE = EW_PROJECT_NAME & "_LanguageFile_qJ72Fb7Bb6vk9t55" ' Language File Cache
Dim EW_SESSION_LANGUAGE_CACHE
EW_SESSION_LANGUAGE_CACHE = EW_PROJECT_NAME & "_Language_qJ72Fb7Bb6vk9t55" ' Language Cache
...
' Css file name
Const EW_PROJECT_STYLESHEET_FILENAME = "css/vslpaypal.css"

' Database settings
Dim EW_DB_CONNECTION_STRING ' DB Connection String
EW_DB_CONNECTION_STRING = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & Request.ServerVariables("APPL_PHYSICAL_PATH") & "/demo/db/vsl2003.mdb" & ";"
...
Const EW_ADMIN_PASSWORD = "web4login" ' Administrator password
...
' User table filters
Const EW_USER_TABLE = "[Logins]"
Const EW_USER_NAME_FILTER = "([Loginname] = '%u')"
...
' Menu
Const EW_MENUBAR_CLASSNAME = "yuimenu"
Const EW_MENUBAR_ITEM_CLASSNAME = "yuimenuitem"
Const EW_MENUBAR_ITEM_LABEL_CLASSNAME = "yuimenuitemlabel"
Const EW_MENU_CLASSNAME = "yuimenu"
Const EW_MENU_ITEM_CLASSNAME = "yuimenuitem" ' Vertical
Const EW_MENU_ITEM_LABEL_CLASSNAME = "yuimenuitemlabel" ' Vertical
%>
