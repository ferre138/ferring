...
' Define page object
Dim Products_fImage_blobview
Set Products_fImage_blobview = New cProducts_fImage_blobview
Set Page = Products_fImage_blobview

' Page init processing
Call Products_fImage_blobview.Page_Init()

' Page main processing
Call Products_fImage_blobview.Page_Main()
%>
<%

' Drop page object
Set Products_fImage_blobview = Nothing
%>
<%
...
' Page Class
'
Class cProducts_fImage_blobview
	...
	Public Property Get PageObjName()
		PageObjName = "Products_fImage_blobview"
	End Property
	...
	Sub Page_Main()
		...
		If Not Recordset.Eof Then
			...
			If Recordset("fImage")&"" <> "" Then
				Response.AddHeader "Content-Disposition", "attachment; filename=""" & Recordset("fImage") & """"
			End If
			objBinary.Value = Recordset("fImage").Value
