...
%>
<a href="Orderslist.asp?<%= EW_TABLE_SHOW_MASTER %>=Customers&CustomerID=<%= Server.URLEncode(Customers.CustomerID.CurrentValue&"") %>" name="ew_Customers_Orders_DetailLink" id="ew_Customers_Orders_DetailLink" onmouseover="ew_AjaxShowDetails(this, 'Orderspreview.asp?f=<%= sSqlWrk %>')" onmouseout="ew_AjaxHideDetails(this);"><%= Language.TablePhrase("Orders", "TblCaption") %>
</a>
&nbsp;
<% End If %>
<% End If %>
