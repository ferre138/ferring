...
Class cdefault
	...
	Sub Page_Main()
		...
		If Security.IsLoggedIn() Then
			Call Page_Terminate("controlpanel.asp") ' Exit and go to default page
		End If
		If Security.IsLoggedIn() Then
			Call Page_Terminate("OrderDetailslist.asp")
		End If
		If Security.IsLoggedIn() Then
			Call Page_Terminate("Productslist.asp")
		End If
		If Security.IsLoggedIn() Then
			Call Page_Terminate("Customerslist.asp")
		End If
		If Security.IsLoggedIn() Then
			Call Page_Terminate("Loginslist.asp")
		End If
		If Security.IsLoggedIn() Then
			Call Page_Terminate("Provincelist.asp")
		End If
		If Security.IsLoggedIn() Then
			Call Page_Terminate("Daily_reportreport.asp")
		End If
		If Security.IsLoggedIn() Then
			Call Page_Terminate("Discountcodeslist.asp")
		End If
		If Security.IsLoggedIn() Then
			Call Page_Terminate("DiscountTypeslist.asp")
		End If
		If Security.IsLoggedIn() Then
