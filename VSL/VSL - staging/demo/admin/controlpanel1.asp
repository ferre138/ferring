...
%></td>
	...
	strHtml=""
	sSql = "SELECT TOP 8 DiscountTypes.DiscountTitle, Count(Discountcodes.Discountid) AS CountOfDiscountid ,Discountcodes.DiscountTypeId"
	sSql=sSql & " FROM Discountcodes INNER JOIN DiscountTypes ON Discountcodes.DiscountTypeId = DiscountTypes.DiscountTypeId GROUP BY DiscountTypes.DiscountTitle, Discountcodes.used,Discountcodes.DiscountTypeId HAVING (((Discountcodes.used)=False)); "
