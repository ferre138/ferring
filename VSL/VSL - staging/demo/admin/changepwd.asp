...
Class cchangepwd
	...
	Sub Page_Init()
		...
		Call Security.LoadCurrentUserLevel("Logins")
		...
		If Request.Form <> "" Then
			...
			If ValidateForm(sOPwd, sNPwd, sCPwd) Then
				...
				If Not RsUser.Eof Then
					If ew_ComparePassword(RsUser("Loginpass"), sOPwd) Then
						bValidPwd = True
						...
						If bValidPwd Then
							...
							If EW_ENCRYPTED_PASSWORD Then
								RsUser("Loginpass") = ew_EncryptPassword(sNPwd) ' Change Password
							Else
								RsUser("Loginpass") = sNPwd ' Change Password
							End If
							RsUser.Update
							bPwdUpdated = True
						Else
