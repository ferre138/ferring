...
Class cDaily_report
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "Province", Province)
	End Sub
	...
	Public Property Get SqlGroupSelect() ' Select
		SqlGroupSelect = "SELECT DISTINCT [Province],[Paymentdate] FROM [ReportOrders]"
	End Property
	...
	Public Property Get SqlGroupOrderBy() ' Order By
		SqlGroupOrderBy = "[Province] ASC,[Paymentdate] ASC"
	End Property
...
'			End If
	...
	Public Property Get Paymentdate()
		If Not IsObject(m_Paymentdate) Then
			Set m_Paymentdate = NewFldObj("Daily_report", "Daily report", "x_Paymentdate", "Paymentdate", "[Paymentdate]", 135, 8, "", False, False, "FORMATTED TEXT")
		End If
	...
	Public Property Get Province()
		If Not IsObject(m_Province) Then
			Set m_Province = NewFldObj("Daily_report", "Daily report", "x_Province", "Province", "[Province]", 202, 8, "", False, False, "FORMATTED TEXT")
		End If
		Set Province = m_Province
	End Property
	Dim Fields ' Fields
	...
	Private Sub Class_Terminate
		...
		If IsObject(m_Province) Then Set m_Province = Nothing
...
If Not Daily_report_report.Recordset.Eof Then
	Daily_report.Province.DbValue = Daily_report_report.Recordset("Province")
	Daily_report_report.ReportGroups(0) = Daily_report.Province.DbValue
...
%>
	<tr><td class="ewGroupField"><span class="aspmaker"><%= Daily_report.Province.FldCaption %></span></td>
	<td colspan=9 class="ewGroupName"><span class="aspmaker">
<div<%= Daily_report.Province.ViewAttributes %>><%= Daily_report.Province.ViewValue %></div>
</span></td></tr>
<%
	End If
	If Daily_report_report.LevelBreak(2) Then ' Reset counter and aggregation
%>
	<tr><td class="ewGroupField"><span class="aspmaker"><%= Daily_report.Paymentdate.FldCaption %></span></td>
	<td colspan=9 class="ewGroupName"><span class="aspmaker">
<div<%= Daily_report.Paymentdate.ViewAttributes %>><%= Daily_report.Paymentdate.ViewValue %></div>
</span></td></tr>
<%
	End If
	...
	Daily_report_report.ReportFilter = Daily_report_report.DefaultFilter
	If Daily_report_report.ReportFilter <> "" Then Daily_report_report.ReportFilter = Daily_report_report.ReportFilter & " AND "
	If IsNull(Daily_report.Province.CurrentValue) Then
		Daily_report_report.ReportFilter = Daily_report_report.ReportFilter & "([Province] IS NULL)"
	Else
		Daily_report_report.ReportFilter = Daily_report_report.ReportFilter & "([Province] = '" & ew_AdjustSql(Daily_report.Province.CurrentValue) & "')"
	End If
	If Daily_report_report.ReportFilter <> "" Then Daily_report_report.ReportFilter = Daily_report_report.ReportFilter & " AND "
	...
	If Daily_report_report.RecCnt = 1 Then
		Daily_report_report.ReportCounts(0) = 0
		Daily_report_report.ReportTotals(0,4) = 0
	...
	For i = 1 to 2
		If Daily_report_report.LevelBreak(i) Then ' Reset counter and aggregation
			...
			Daily_report_report.ReportTotals(i, 4) = 0
...
<%
	Do While Not Daily_report_report.DetailRecordset.Eof
		...
		Daily_report.payment_gross.DbValue = Daily_report_report.DetailRecordset("payment_gross")
		Daily_report_report.ReportTotals(0, 4) = Daily_report_report.ReportTotals(0, 4) + Daily_report.payment_gross.CurrentValue
		Daily_report_report.ReportTotals(1, 4) = Daily_report_report.ReportTotals(1, 4) + Daily_report.payment_gross.CurrentValue
		Daily_report_report.ReportTotals(2, 4) = Daily_report_report.ReportTotals(2, 4) + Daily_report.payment_gross.CurrentValue
		Daily_report.payment_fee.DbValue = Daily_report_report.DetailRecordset("payment_fee")
		Daily_report_report.ReportTotals(0, 5) = Daily_report_report.ReportTotals(0, 5) + Daily_report.payment_fee.CurrentValue
		Daily_report_report.ReportTotals(1, 5) = Daily_report_report.ReportTotals(1, 5) + Daily_report.payment_fee.CurrentValue
		Daily_report_report.ReportTotals(2, 5) = Daily_report_report.ReportTotals(2, 5) + Daily_report.payment_fee.CurrentValue
		Daily_report.Shipping.DbValue = Daily_report_report.DetailRecordset("Shipping")
		Daily_report_report.ReportTotals(0, 6) = Daily_report_report.ReportTotals(0, 6) + Daily_report.Shipping.CurrentValue
		Daily_report_report.ReportTotals(1, 6) = Daily_report_report.ReportTotals(1, 6) + Daily_report.Shipping.CurrentValue
		Daily_report_report.ReportTotals(2, 6) = Daily_report_report.ReportTotals(2, 6) + Daily_report.Shipping.CurrentValue
		Daily_report.Tax.DbValue = Daily_report_report.DetailRecordset("Tax")
...
<%
	...
	' Save old group data
	Daily_report_report.ReportGroups(0) = Daily_report.Province.CurrentValue
...
%>
	<tr><td colspan=10 class="ewGroupSummary"><span class="aspmaker"><%= Language.Phrase("RptSumHead") %>&nbsp;<%= Daily_report.Paymentdate.FldCaption %>:&nbsp;<%= Daily_report.Paymentdate.ViewValue %>&nbsp;(<%= FormatNumber(Daily_report_report.ReportCounts(2),0) %>&nbsp;<%= Language.Phrase("RptDtlRec") %>)</span></td></tr>
<%
	Daily_report.payment_gross.CurrentValue = Daily_report_report.ReportTotals(2,4)
	Daily_report.payment_fee.CurrentValue = Daily_report_report.ReportTotals(2,5)
	Daily_report.Shipping.CurrentValue = Daily_report_report.ReportTotals(2,6)
...
End If
	If Daily_report_report.LevelBreak(1) Then
		Daily_report.Province.CurrentValue = Daily_report_report.ReportGroups(0)

		' Render row for view
		Daily_report.RowType = EW_ROWTYPE_VIEW
		Call Daily_report.ResetAttrs()
		Call Daily_report_report.RenderRow()
		Daily_report.Province.CurrentValue = Daily_report.Province.DbValue
%>
	<tr><td colspan=10 class="ewGroupSummary"><span class="aspmaker"><%= Language.Phrase("RptSumHead") %>&nbsp;<%= Daily_report.Province.FldCaption %>:&nbsp;<%= Daily_report.Province.ViewValue %>&nbsp;(<%= FormatNumber(Daily_report_report.ReportCounts(1),0) %>&nbsp;<%= Language.Phrase("RptDtlRec") %>)</span></td></tr>
<%
	Daily_report.payment_gross.CurrentValue = Daily_report_report.ReportTotals(1,4)
	Daily_report.payment_fee.CurrentValue = Daily_report_report.ReportTotals(1,5)
	Daily_report.Shipping.CurrentValue = Daily_report_report.ReportTotals(1,6)
...
<%
	Daily_report.payment_gross.CurrentValue = Daily_report_report.ReportTotals(0,4)
	Daily_report.payment_fee.CurrentValue = Daily_report_report.ReportTotals(0,5)
	Daily_report.Shipping.CurrentValue = Daily_report_report.ReportTotals(0,6)
...
Class cDaily_report_report
	...
	Sub ChkLvlBreak()
		...
		If RecCnt = 0 Then ' Start Or End of Recordset
			...
			LevelBreak(2) = True
		Else
			If Not ew_CompareValue(Daily_report.Province.CurrentValue, ReportGroups(0)) Then
				LevelBreak(1) = True
				LevelBreak(2) = True
			End If
	...
	Sub RenderRow()
		...
		If Daily_report.RowType = EW_ROWTYPE_VIEW Then ' View row
			...
			' Province
			Daily_report.Province.ViewValue = Daily_report.Province.CurrentValue
			Daily_report.Province.ViewCustomAttributes = ""
			...
			' Province
			Daily_report.Province.LinkCustomAttributes = ""
			Daily_report.Province.HrefValue = ""
			Daily_report.Province.TooltipValue = ""
		End If
