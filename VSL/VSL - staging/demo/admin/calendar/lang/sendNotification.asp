...
'assign posted variables to local variables
 ...
 If IsEmpty(invoice) Then invoice = Session("InvoiceId")
 ...
 if (objHttp.status <> 200 ) then
	...
	strSQL = strSQL & " WHERE InvoiceId =" & invoice & ";"  
	conn.Execute(strSQL)
...
function getEmailText(InvId,conn)
	...
	sBody  = "New order submission from VSL3.ca on " & Now &   vbcrlf
	...
	sBody  =sBody & "</tr>"
	strSQL = "SELECT products.ItemNo AS ItemNo,products.Description AS Description,products.Price AS Price,orderdetails.Quantity AS Quantity "
	strSQL = strSQL & " FROM orders,orderdetails,products WHERE orders.orderId = orderdetails.orderId and products.itemid = orderdetails.productId and orders.InvoiceId = " & InvId & ";"
	...
	sBody  =sBody & "<br /><div style='font-family: Verdana;font-size: 14px; padding-top:10px;' ><a href='http://www.ravenshoegroup.ca/vslpaypal/admin'><i>Please login to see the payment.</i></a></div>"
