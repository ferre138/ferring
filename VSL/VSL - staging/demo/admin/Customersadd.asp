...
<p>
<% If Customers.CurrentDetailTable = "Orders" And Orders.DetailAdd Then %>
<br>
...
Class cCustomers_add
		...
		Select Case Customers.CurrentAction
			...
			Case "A" ' Add new record
				...
				If AddRow(OldRecordset) Then ' Add successful
					...
					Dim sReturnUrl
					If Customers.CurrentDetailTable <> "" Then ' Master/detail add
	...
	Function AddRow(RsOld)
		...
		If AddRow Then
			If Customers.CurrentDetailTable = "Orders" And Orders.DetailAdd Then
				Orders.CustomerId.SessionValue = Customers.CustomerID.CurrentValue ' Set master key
				Dim Orders_grid
				Set Orders_grid = New cOrders_grid ' get detail page object
				AddRow = Orders_grid.GridInsert
				Set Orders_grid = Nothing
			End If
		End If
	...
	Sub SetUpDetailParms()
		...
		If sDetailTblVar <> "" Then
			If sDetailTblVar = "Orders" Then
				...
				End If
				If Orders.DetailAdd Then
					If CopyRecord Then
						Orders.CurrentMode = "copy"
					Else
						Orders.CurrentMode = "add"
					End If
