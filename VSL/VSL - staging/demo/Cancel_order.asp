  ...
  <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="820" height="25"><table width="820" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="120" align="left" valign="top"><div align="right" class="bodycopy_small">
                <p>&nbsp;</p>
                <p><a href="french/Cancel_order.asp?<%=request.QueryString%>">en fran&ccedil;ais &gt;</a></p>
              </div></td>
            </tr>
            <tr>
	...
	if (Not Security.IsLoggedIn()) then%>
	 ...
	 %>
                    ...
                    <i>
                      <div style="font-family: Verdana;font-size: 14px; padding-top:10px;" ><strong>Cancelled transaction.</strong></div>
