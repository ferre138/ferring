...
%>
			...
			<%if((Month(now()) & year(now())="102012") or ((Month(now()) & year(now())="92012"))) then %>
				<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >La vente 5ème anniversaire</font></p>
				<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >Du 1er au 31 octobre, 2012</font></p>
				<p style="background-color: #FFFFCC;"><font color="#FF0000" size="+1" >Avec chaque achat de 3 boîtes de VSL#3<sup>MD</sup> (30), vous recevrez une boîte additionnelle gratuitement.</font></p>
				<p style="background-color: #FFFFCC;"><font color="#FF0000"  >Afin de profiter de cette <b>vente</b>, clients existants, s'il vous plaît utiliser le code du coupon que vous recevrez sous peu par la poste. Pour les nouveaux clients, appelez le bureau des commandes pour obtenir votre code et placer votre commande.</font></p>
			<%end if %>
	</td></tr>
<%
...
%></td>
	  ...
	  <td<%= Products.Active.CellAttributes %>><p align="right" class="vslcss"><strong>Prix unitaire:</strong><%= Products.Price.ViewValue %> $ boite<br> 
	    <br>
...
<tr>
  ...
  <div >
    ...
    <p align="left" class="vslcss">&nbsp;</p>
    <p align="left" class="vslcss">Si vous payez en argent comptant, s'il vous plaît appellez le 416 642 0075 ou sans frais au 1 877 681 7464 pour placer votre commande.</p>
