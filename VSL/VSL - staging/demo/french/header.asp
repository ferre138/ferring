...
<!-- Bootstrap Framework-->
    ...
    <link href="../vslold.css" rel="stylesheet">
...
<div class="container">
    <div id="logo"><a href="http://vsl3.ca/"><img src="../_images/vsl3-logo-fre.png" width="212" alt="VSL#3"></a></div>
    <div id="logoTab"><a href="http://vsl3.ca/"><img src="../_images/vsl3-logo-fre.png" width="165" alt="VSL#3"></a></div>
<div class="row ">
 
  <div class="col-sm-12 col-md-12">
	<ul class="nav nav-pills">
      <li><a href="http://vsl3.ca/VSLOrderForm.asp" class="topNavigation">English</a></li>
...
<!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">  
      <ul id="navigation" class="nav navbar-nav navbar-right">
        ...
        <li class="nav-fre"><a href="about-VSL.html" class="mainNavigation">À propos de VSL#3<sup>&reg;</sup></a></li>
        ...
        <li class="nav-fre"><a href="./french/frequently-asked-questions.html" class="mainNavigation">FAQ</a></li>
...
// Ajax settings
EW_LOOKUP_FILE_NAME = "ewlookup60.asp"; // lookup file name
EW_ADD_OPTION_FILE_NAME = "ewaddopt60.asp"; // add option file name
...
<script type="text/javascript" src="ew60.js"></script>
<script type="text/javascript" src="userfn60.js"></script>
