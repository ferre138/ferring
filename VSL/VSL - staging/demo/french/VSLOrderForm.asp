...
<table width="820" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><h3 class="red-box-sm white">À compter du 1er juin 2015, le prix de VSL#3 sera 110.00 $ par boîte.  <br />
Le nouveau prix comprendra les frais d’expédition.</h3></td>
  </tr>
</table>
<table  border="0" cellpadding="0" cellspacing="0" id="Table_01">
            <tr>
            <td width="440" rowspan="2"><h1 class="h1-header" style="padding:20px 0px 20px 0px; color:#0067A7;">Commandez VSL#3<sup style="font-size:24px;">MD</sup> ici</h1></td>
              <td width="240" rowspan="2"><div align="right"></div></td>
