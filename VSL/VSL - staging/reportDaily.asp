...
'			End If
	...
	Public Property Get OrderId()
		If Not IsObject(m_OrderId) Then
			Set m_OrderId = NewFldObj("Daily_report", "Daily report", "x_OrderId", "OrderId", "[OrderId]", 3, 8, "", False, False, "FORMATTED TEXT")
...
%>
	<tr>
		<td></td>
		<td valign="top" class="ewGroupHeader"><span class="aspmaker"><%= Daily_report.OrderId.FldCaption %></span></td>
...
<%
	Do While Not Daily_report_report.DetailRecordset.Eof
		Daily_report.OrderId.DbValue = Daily_report_report.DetailRecordset("OrderId")
...
<div<%= Daily_report.OrderId.ViewAttributes %>><%= Daily_report.OrderId.ViewValue %></div>
</span></td>
		<td><span class="aspmaker">
...
Class cDaily_report_report
	...
	Sub RenderRow()
		...
		If Daily_report.RowType = EW_ROWTYPE_VIEW Then ' View row
			...
			' OrderId
			Daily_report.OrderId.ViewValue = Daily_report.OrderId.CurrentValue
			Daily_report.OrderId.ViewCustomAttributes = ""
			...
			Daily_report.OrderId.LinkCustomAttributes = ""
			Daily_report.OrderId.HrefValue = ""
			Daily_report.OrderId.TooltipValue = ""
