...
<table width="820" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="120" align="left" valign="top"><div align="right" class="bodycopy_small">
      <p>&nbsp;</p>
      <p><a href="french/Cancel_order.asp?<%=request.QueryString%>">French &gt;</a></p>
    </div></td>
  </tr>
  <tr>
	...
	if (Not Security.IsLoggedIn()) then%>
          ...
          <%end if
	 %>
          <table width="610" border="1" cellspacing="0" cellpadding="9">
          
          </table>
          <i>
            <div style="font-family: Verdana;font-size: 14px; padding-top:10px;color:black" ><strong>Transaction Cancelled</strong></div>
