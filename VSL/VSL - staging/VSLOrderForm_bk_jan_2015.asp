...
The final day for ordering VSL#3 in 2013 for next-day delivery will be Thursday December 19, 2013.  Next-day deliveries will resume as of January 6, 2014. <br>
</span>
				  <%end if%>
                      </td></tr>
<%
...
<% End If %></td>
	  ...
	  <td align="right"<%= Products.Active.CellAttributes %>><p align="right" class="vslcss"><strong>Price:</strong> $<%= Products.Price.ViewValue %> /pack<br> 
	    <br>
	    ...
	    <p align="right" class="vslcss"><br>
            ...
            <br>
            <span class="footer">Minimum Qty:2</span>  
...
<tr>
  ...
  <div >
    ...
    <p align="left" class="vslcss">&nbsp; </p>
	 <p align="left" class="vslcss"><strong>Last day to place a VSL#3 order in 2014 is Dec 17 midnight, to be delivered by Dec 19.  Shipping will resume Jan 5, 2015</strong></p>
