...
<div class="default-wrapper">
 ...
 <div class="col-sm-12 col-md-8 content">
    	...
    	*
    	<input type="text" class="form-control" id="FirstName" name="firstName"  <?php if(isset($_SESSION['firstName'])) echo 'value="'.$_SESSION['firstName'].'"'; ?>>
 		  </div>
        
        <div class="form-group">
   	 	<label for="Company">Organization/Company</label>
    	<input type="text" class="form-control" id="Company" name="company" <?php if(isset($_SESSION['company'])) echo 'value="'.$_SESSION['company'].'"'; ?>>
  		</div>
        
        <div class="form-group">
   	 	<label for="PostalCode">Postal Code</label>
   	 	*
    	<input type="text" class="form-control" id="PostalCode" name="postal" <?php if(isset($_SESSION['postal'])) echo 'value="'.$_SESSION['postal'].'"'; ?>>
  		</div>
        
        <div class="form-group">
   	 	<label for="Telephone">Telephone*</label>
    	<input type="tel" class="form-control" id="Telephone" name="phone" <?php if(isset($_SESSION['phone'])) echo 'value="'.$_SESSION['phone'].'"'; ?>>
  		</div>
        
        <div class="form-group">
   	 	<label for="Fax">Fax</label>
    	<input type="tel" class="form-control" id="Fax" name="fax" <?php if(isset($_SESSION['fax'])) echo 'value="'.$_SESSION['fax'].'"'; ?>>
  		</div>
        ...
        <div class="form-group">
   	 	...
   	 	*
   	 	<input type="text" class="form-control" id="LastName" name="lastName" <?php if(isset($_SESSION['lastName'])) echo 'value="'.$_SESSION['lastName'].'"'; ?>>
  		</div>
       ...
       <div class="form-group">
        ...
        <textarea class="form-control" id="Message" rows="7" name="message"><?php if(isset($_SESSION['message'])) echo $_SESSION['message']; ?></textarea>
        </div>
       	<input name="honey" type="text" class="honey-class">
