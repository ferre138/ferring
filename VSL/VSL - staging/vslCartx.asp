...
<div class="t">
  <div align="right"><span class="vslcss"><a href="VSLOrderFormx.asp">Back to Products</a> :
          <%
	Dim Security
...
<table width="775"  class="ewTablecart" cellpadding="5" cellspacing="5" border="1">
  ...
  <tr >
    ...
    <td width="10%"style="padding:5px;">
      <div align="center"><b><a href='vslCartx.asp?ItemId=<%=arr(i,0)%>&link=del' onClick="return confirm('delete item: <%=arr(i,0)%> from cart ?')"><b>Delete</b></a>
  ...
  <tr bordercolor="#FFCC66">
    ...
    <td colspan="4" nowrap><a href="vslCartx.asp?link=checkout"><img src="images/checkout.gif" width="115" height="32" border="0"></a> <a href="vslCartx.asp?link=clear" onClick="return confirm(' Empty all items from the cart ?');"><img src="images/cancelorder.gif" width="139" height="32" border="0"></a></td>
    </tr>
</table>
</div>
</form> 
...
Sub PrepareCart()
	...
	response.redirect("checkoutx.asp")
%>
...
<form action="http://ww11.aitsafe.com/cf/addmulti.cfm" name="qForm" method="post"> 
    <input type="hidden" name="useridsd" value="D6155807"> 
    <input type="hidden" name="return" value="http://localhost/vsl/cartx.asp"> 
	<%For i=0 To UBound(arr)%>
	<%=arr(i,0)%>
