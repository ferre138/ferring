...
%>
  <form action="https://www.paypal.com/cgi-bin/webscr" method="post" name="MyForm">
	...
	<input type="hidden" name="business" value="skarkera@ravenshoegroup.com" />
...
<input type="hidden" name="return" value="http://www.vsl3.ca/beta/Thank-you.asp?token=<%=OrderNum%>">	
<input type="hidden" name="cancel_return" value="http://www.vsl3.ca/beta/Cancel_order.asp?token=<%=OrderNum%>">
