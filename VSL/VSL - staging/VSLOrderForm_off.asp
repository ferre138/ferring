<!doctype html>
<html><!-- InstanceBegin template="/Templates/template-error.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<meta charset="UTF-8">
  ...
  <div class="col-sm-12 col-md-12">
	<ul class="nav nav-pills">
	  <!-- InstanceBeginEditable name="French" -->
	    <li><a href="http://vsl3.ca/french/error404.html" class="topNavigation">Français</a></li>
  ...
  <div class="container">
	...
	<div class="row">
      ...
      <div class="col-sm-12 col-md-12 text-center">
      	<h1 class="h1-header">System is being updated, Please try later..<br>
      	</h1>
...
<div class="icon-wrapper">
  <div class="container">
	<div class="row calloutPad">
 		...
 		<h2 class="h2-blue">Testimonials</h2>
 		<h3 style="padding:0px 12px 0px 12px;">“Within one week of taking VSL#3, I was sleeping through the night, which has not happened for many years...”<br>
 		  <br><a href="/testimonials.html" class="arrow-link">Full Testimonials Page</a></h3></div>
        <div class="col-sm-4 col-md-4 text-center"><img src="/_images/research-icon.png" width="100" height="100" alt="Research">
 		<h2 class="h2-blue">Research</h2><h3 style="padding:0px 12px 0px 12px;"><a href="/ileal-pouch-studies.html" class="orange-link">Ileal Pouch Studies</a><br>
 		  <a href="/ulcerative-colitis-studies.html" class="orange-link">Ulcerative Colitis Studies</a><br>
	      <a href="/other-studies.html" class="orange-link">Other Studies</a><br><br><a href="/research.html" class="arrow-link">View All Resources</a></h3></div>
        <div class="col-sm-4 col-md-4 text-center"><img src="/_images/faqs-icon.png" width="100" height="100" alt="FAQs">
 		<h2 class="h2-blue">FAQs</h2><h3 style="padding:0px 12px 0px 12px;">See a list of frequently asked question<br>
	    by people just like you.<br>
	    <br><br><a href="/frequently-asked-questions.html" class="arrow-link">Click Here For FAQs</a></h3></div>
