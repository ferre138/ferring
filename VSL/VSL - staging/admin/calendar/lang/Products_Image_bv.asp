...
' Define page object
Dim Products_Image_blobview
Set Products_Image_blobview = New cProducts_Image_blobview
Set Page = Products_Image_blobview

' Page init processing
Call Products_Image_blobview.Page_Init()

' Page main processing
Call Products_Image_blobview.Page_Main()
%>
<%

' Drop page object
Set Products_Image_blobview = Nothing
%>
<%
...
Class cProducts_Image_blobview
	...
	Public Property Get PageObjName()
		PageObjName = "Products_Image_blobview"
	End Property
	...
	Sub Page_Main()
		...
		If Not Recordset.Eof Then
			...
			If Recordset("Image")&"" <> "" Then
				Response.AddHeader "Content-Disposition", "attachment; filename=""" & Recordset("Image") & """"
			End If
			objBinary.Value = Recordset("Image").Value
