...
<% If Orders.payment_date.Visible Then ' payment_date %>
	<% If Orders.SortUrl(Orders.payment_date) = "" Then %>
		<td><%= Orders.payment_date.FldCaption %></td>
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Orders.SortUrl(Orders.payment_date) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Orders.payment_date.FldCaption %></td><td style="width: 10px;"><% If Orders.payment_date.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Orders.payment_date.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
<% If Orders.pfirst_name.Visible Then ' pfirst_name %>
	<% If Orders.SortUrl(Orders.pfirst_name) = "" Then %>
		<td><%= Orders.pfirst_name.FldCaption %></td>
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Orders.SortUrl(Orders.pfirst_name) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Orders.pfirst_name.FldCaption %><%= Language.Phrase("SrchLegend") %></td><td style="width: 10px;"><% If Orders.pfirst_name.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Orders.pfirst_name.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
<% If Orders.plast_name.Visible Then ' plast_name %>
	<% If Orders.SortUrl(Orders.plast_name) = "" Then %>
		<td><%= Orders.plast_name.FldCaption %></td>
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Orders.SortUrl(Orders.plast_name) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Orders.plast_name.FldCaption %><%= Language.Phrase("SrchLegend") %></td><td style="width: 10px;"><% If Orders.plast_name.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Orders.plast_name.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
...
<% If Orders.txn_id.Visible Then ' txn_id %>
	<% If Orders.SortUrl(Orders.txn_id) = "" Then %>
		<td><%= Orders.txn_id.FldCaption %></td>
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Orders.SortUrl(Orders.txn_id) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Orders.txn_id.FldCaption %><%= Language.Phrase("SrchLegend") %></td><td style="width: 10px;"><% If Orders.txn_id.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Orders.txn_id.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
...
<% If Orders.payment_type.Visible Then ' payment_type %>
	<% If Orders.SortUrl(Orders.payment_type) = "" Then %>
		<td><%= Orders.payment_type.FldCaption %></td>
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Orders.SortUrl(Orders.payment_type) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Orders.payment_type.FldCaption %><%= Language.Phrase("SrchLegend") %></td><td style="width: 10px;"><% If Orders.payment_type.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Orders.payment_type.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
<% If Orders.txn_type.Visible Then ' txn_type %>
	<% If Orders.SortUrl(Orders.txn_type) = "" Then %>
		<td><%= Orders.txn_type.FldCaption %></td>
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Orders.SortUrl(Orders.txn_type) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Orders.txn_type.FldCaption %><%= Language.Phrase("SrchLegend") %></td><td style="width: 10px;"><% If Orders.txn_type.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Orders.txn_type.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
...
<% If Orders.EmailSent.Visible Then ' EmailSent %>
	...
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Orders.SortUrl(Orders.EmailSent) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Orders.EmailSent.FldCaption %><%= Language.Phrase("SrchLegend") %></td><td style="width: 10px;"><% If Orders.EmailSent.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Orders.EmailSent.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
...
Class cOrders_list
	...
	Sub SetUpSortOrder()
		...
		If Request.QueryString("order").Count > 0 Then
			...
			' Field payment_date
			Call Orders.UpdateSort(Orders.payment_date)

			' Field pfirst_name
			Call Orders.UpdateSort(Orders.pfirst_name)

			' Field plast_name
			Call Orders.UpdateSort(Orders.plast_name)

			' Field payer_email
			Call Orders.UpdateSort(Orders.payer_email)

			' Field txn_id
			Call Orders.UpdateSort(Orders.txn_id)
			...
			' Field payment_type
			Call Orders.UpdateSort(Orders.payment_type)

			' Field txn_type
			Call Orders.UpdateSort(Orders.txn_type)
	...
	Sub ResetCmd()
		...
		If Request.QueryString("cmd").Count > 0 Then
			...
			If LCase(sCmd) = "resetsort" Then
				...
				Orders.payment_date.Sort = ""
				Orders.pfirst_name.Sort = ""
				Orders.plast_name.Sort = ""
				Orders.payer_email.Sort = ""
				Orders.txn_id.Sort = ""
				Orders.payment_gross.Sort = ""
				Orders.payment_fee.Sort = ""
				Orders.payment_type.Sort = ""
				Orders.txn_type.Sort = ""
				Orders.Tax.Sort = ""
	...
	Sub RenderRow()
		...
		ElseIf Orders.RowType = EW_ROWTYPE_SEARCH Then ' Search row
			...
			Orders.payment_date.EditValue = Orders.payment_date.AdvancedSearch.SearchValue

			' pfirst_name
			Orders.pfirst_name.EditCustomAttributes = ""
			Orders.pfirst_name.EditValue = ew_HtmlEncode(Orders.pfirst_name.AdvancedSearch.SearchValue)

			' plast_name
			Orders.plast_name.EditCustomAttributes = ""
			Orders.plast_name.EditValue = ew_HtmlEncode(Orders.plast_name.AdvancedSearch.SearchValue)
			...
			Orders.txn_id.EditValue = ew_HtmlEncode(Orders.txn_id.AdvancedSearch.SearchValue)
			...
			Orders.payment_type.EditValue = ew_HtmlEncode(Orders.payment_type.AdvancedSearch.SearchValue)

			' txn_type
			Orders.txn_type.EditCustomAttributes = ""
			Orders.txn_type.EditValue = ew_HtmlEncode(Orders.txn_type.AdvancedSearch.SearchValue)
			...
			Orders.EmailSent.EditValue = ew_HtmlEncode(Orders.EmailSent.AdvancedSearch.SearchValue)
...
End Sub                                
	...
	Sub ListOptions_Rendered()
		...
		'Example: 
		if(Orders.payment_status.CurrentValue <> "WIP" or  Orders.payment_status.CurrentValue<>"Cancelled") then    
