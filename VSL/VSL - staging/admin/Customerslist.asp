...
<% If Orders.DetailAdd And Security.IsLoggedIn() Then %>
<a class="ewGridLink" href="<%= Customers.AddUrl & "?" & EW_TABLE_SHOW_DETAIL & "=Orders" %>"><%= Language.Phrase("AddLink") %>&nbsp;<%= Customers.TableCaption %>/<%= Orders.TableCaption %></a>&nbsp;&nbsp;
<% End If %>
<% End If %>
...
Class cCustomers_list
	...
	Private Sub Class_Initialize()
		...
		AddUrl = "Customersadd.asp?" & EW_TABLE_SHOW_DETAIL & "="
	...
	Sub SetupListOptions()
		...
		ListOptions.Add("detail_Orders")
		ListOptions.GetItem("detail_Orders").CssStyle = "white-space: nowrap;"
		ListOptions.GetItem("detail_Orders").Visible = Security.IsLoggedIn()
		ListOptions.GetItem("detail_Orders").OnLeft = True
	...
	Sub RenderListOptions()
		...
		End If
		If Security.IsLoggedIn() Then
			Set item = ListOptions.GetItem("detail_Orders")
			item.Body = "<img src=""images/detail.gif"" alt=""" & ew_HtmlEncode(Language.Phrase("DetailLink")) & """ title=""" & ew_HtmlEncode(Language.Phrase("DetailLink")) & """ width=""16"" height=""16"" border=""0"">" & Language.TablePhrase("Orders", "TblCaption")
			item.Body = "<a class=""ewRowLink"" href=""Orderslist.asp?" & EW_TABLE_SHOW_MASTER & "=Customers&CustomerID=" & Server.URLEncode(Customers.CustomerID.CurrentValue&"") & """>" & item.Body & "</a>"
			links = ""
			If Orders.DetailEdit And Security.IsLoggedIn() And Security.IsLoggedIn() Then
				links = links & "<a class=""ewRowLink"" href=""" & Customers.EditUrl(EW_TABLE_SHOW_DETAIL & "=Orders") & """>" & "<img src=""images/edit.gif"" alt=""" & ew_HtmlEncode(Language.Phrase("EditLink")) & """ title=""" & ew_HtmlEncode(Language.Phrase("EditLink")) & """ width=""16"" height=""16"" border=""0"">" & "</a>&nbsp;"
			End If
	...
	Function RenderListOptionsExt()
		...
		sSqlWrk = "[CustomerId]=" & ew_AdjustSql(Customers.CustomerID.CurrentValue) & ""
		sSqlWrk = ew_Encode(TEAencrypt(sSqlWrk, EW_RANDOM_KEY))
		sSqlWrk = Replace(sSqlWrk, "'", "\'")
		Set oListOpt = ListOptions.GetItem("detail_Orders")
		oListOpt.Body = "<img src=""images/detail.gif"" alt=""" & ew_HtmlEncode(Language.Phrase("DetailLink")) & """ title=""" & ew_HtmlEncode(Language.Phrase("DetailLink")) & """ width=""16"" height=""16"" border=""0"">" & Language.TablePhrase("Orders", "TblCaption")
		sHyperLinkParm = " href=""Orderslist.asp?" & EW_TABLE_SHOW_MASTER & "=Customers&CustomerID=" & Server.URLEncode(Customers.CustomerID.CurrentValue&"") & """ name=""dl%i_Customers_Orders"" id=""dl%i_Customers_Orders"" onmouseover=""ew_AjaxShowDetails(this, 'Orderspreview.asp?f=%s')"" onmouseout=""ew_AjaxHideDetails(this);"""
		...
		links = ""
		If Orders.DetailEdit And Security.IsLoggedIn() And Security.IsLoggedIn() Then
			links = links & "<a href=""" & Customers.EditUrl(EW_TABLE_SHOW_DETAIL & "=Orders") & """>" & "<img src=""images/edit.gif"" alt=""" & ew_HtmlEncode(Language.Phrase("EditLink")) & """ title=""" & ew_HtmlEncode(Language.Phrase("EditLink")) & """ width=""16"" height=""16"" border=""0"">" & "</a>&nbsp;"
		End If
