...
<% If Province.Prov.Visible Then ' Prov %>
	...
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Province.SortUrl(Province.Prov) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Province.Prov.FldCaption %></td><td style="width: 10px;"><% If Province.Prov.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Province.Prov.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
<% If Province.Province_1.Visible Then ' Province %>
	...
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Province.SortUrl(Province.Province_1) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Province.Province_1.FldCaption %></td><td style="width: 10px;"><% If Province.Province_1.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Province.Province_1.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
<% If Province.fProvince.Visible Then ' fProvince %>
	...
	<% Else %>
		<td><div class="ewPointer" onmousedown="ew_Sort(event,'<%= Province.SortUrl(Province.fProvince) %>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><thead><tr><td><%= Province.fProvince.FldCaption %></td><td style="width: 10px;"><% If Province.fProvince.Sort = "ASC" Then %><img src="images/sortup.gif" width="10" height="9" border="0"><% ElseIf Province.fProvince.Sort = "DESC" Then %><img src="images/sortdown.gif" width="10" height="9" border="0"><% End If %></td></tr></thead></table>
		</div></td>
	<% End If %>
<% End If %>		
