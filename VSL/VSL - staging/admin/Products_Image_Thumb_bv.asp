...
' Define page object
Dim Products_Image_Thumb_blobview
Set Products_Image_Thumb_blobview = New cProducts_Image_Thumb_blobview
Set Page = Products_Image_Thumb_blobview

' Page init processing
Call Products_Image_Thumb_blobview.Page_Init()

' Page main processing
Call Products_Image_Thumb_blobview.Page_Main()
%>
<%

' Drop page object
Set Products_Image_Thumb_blobview = Nothing
%>
<%
...
' Page Class
'
Class cProducts_Image_Thumb_blobview
	...
	Public Property Get PageObjName()
		PageObjName = "Products_Image_Thumb_blobview"
	End Property
	...
	Sub Page_Main()
		...
		If Not Recordset.Eof Then
			...
			If Recordset("Image_Thumb")&"" <> "" Then
				Response.AddHeader "Content-Disposition", "attachment; filename=""" & Recordset("Image_Thumb") & """"
			End If
			objBinary.Value = Recordset("Image_Thumb").Value
