...
' ASPMaker configuration for Table Query1
Dim Query1
...
Class cQuery1
	...
	Private Sub Class_Initialize()
		...
		Call ew_SetArObj(Fields, "InvId", InvId)
	End Sub
	...
	Public Property Get HighlightName()
		HighlightName = "Query1_Highlight"
	End Property
	...
	Public Property Get ReturnUrl()
		...
		Else
			ReturnUrl = "Query1list.asp"
		End If
	End Property

	' List url
	Public Function ListUrl()
		ListUrl = "Query1list.asp"
	End Function

	' View url
	Public Function ViewUrl()
		ViewUrl = KeyUrl("Query1view.asp", UrlParm(""))
	End Function
...
'		If sUrlParm <> "" Then AddUrl = AddUrl & "?" & sUrlParm
	...
	Public Function EditUrl(parm)
		EditUrl = KeyUrl("Query1edit.asp", UrlParm(parm))
	End Function
	...
	Public Function CopyUrl(parm)
		CopyUrl = KeyUrl("Query1add.asp", UrlParm(parm))
	End Function
	...
	Public Function DeleteUrl()
		DeleteUrl = KeyUrl("Query1delete.asp", UrlParm(""))
	End Function
	...
	Sub RenderListRow()
		...
		InvId.ViewValue = InvId.CurrentValue
		InvId.ViewCustomAttributes = ""

		' InvId
		InvId.LinkCustomAttributes = ""
		InvId.HrefValue = ""
		InvId.TooltipValue = ""
		...
		Do While Not Recordset.Eof And RecCnt < StopRec
			...
			If CLng(RecCnt) >= CLng(StartRec) Then
				...
				If ExportPageType = "view" Then
					Call XmlDoc.AddField("InvId", InvId.ExportValue(Export, ExportOriginalValue))
				Else
					Call XmlDoc.AddField("InvId", InvId.ExportValue(Export, ExportOriginalValue))
				End If
			End If
...
'			End If
	...
	Public Property Get InvId()
		If Not IsObject(m_InvId) Then
			Set m_InvId = NewFldObj("Query1", "Query1", "x_InvId", "InvId", "[InvId]", 3, 8, "", False, False, "FORMATTED TEXT")
			m_InvId.FldDefaultErrMsg = Language.Phrase("IncorrectInteger")
		End If
		Set InvId = m_InvId
	End Property
	Dim Fields ' Fields
	...
	Private Sub Class_Terminate
		If IsObject(m_InvId) Then Set m_InvId = Nothing
