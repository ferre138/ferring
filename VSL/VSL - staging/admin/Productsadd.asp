...
Products_add.MultiPage.AddElement("x_Price_rebate", 1);
...
Class cProducts_add
	...
	Function LoadDefaultValues()
		...
		Products.Price_rebate.CurrentValue = Null
		Products.Price_rebate.OldValue = Products.Price_rebate.CurrentValue
	...
	Function AddRow(RsOld)
		...
		' Field Price_rebate
		Call Products.Price_rebate.SetDbValue(Rs, Products.Price_rebate.CurrentValue, Null, False)
