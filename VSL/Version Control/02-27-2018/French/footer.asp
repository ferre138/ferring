...
<div class="row "> 
 ...
 <div class="col-sm-12 col-md-12 text-center tb-pad">
  ...
  <div class="col-sm-6 col-md-6"> 
  	  ...
  	  <div id="ferringRight"><h6>VSL#3<sup>&reg;</sup> est un mélange probiotique qui devrait être utilisé sous la supervision d'un médecin. Veuillez consulter votre médecin avant d'essayer VSL#3<sup>&reg;</sup></h6></div>
  </div>
