...
<div class="row ">
  ...
  <div class="col-sm-12 col-md-12">
	<ul class="nav nav-pills">
     <li><a href="http://vsl3.ca/french/VSLOrderForm.asp" class="topNavigation">Fran&ccedil;ais</a></li>
      <li style="color:#FFF; padding:10px 5px 0px 5px;">&bullet;</li>
      <li><a href="contact-us.asp" class="topNavigation">Contact Us</a></li>
      <li style="color:#FFF; padding:10px 5px 0px 5px;" class="desktop">&bullet;</li>
      <li class="desktop"><a href="http://vsl3.ca/" class="topNavigation">Home</a></li>
    <li style="color:#FFF; padding:10px 5px 0px 5px;">&bullet;</li>
      <li><a href="store-locator.html" class="topNavigation">Where To Buy</a></li>
	</ul>
  </div>
